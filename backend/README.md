...
## Project Structure
    ...
    ├── trilogy_marketing_30237  # Django project configurations
...
1. Clone this repo and `cd trilogy_marketing_30237`
...
2. Clone this repo and `cd trilogy_marketing_30237`
